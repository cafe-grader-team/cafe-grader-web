...
# Map fixture filenames to model classes (join tables with custom table_name)
module FixtureClassMapping
...
RSpec.configure do |config|
  config.include FixtureClassMapping, type: :request
  # Reuse existing Minitest fixtures
  ...
  # Reset GraderConfiguration cache before each test
